...
module.exports = (suite(({ addFile, addFiles, addCode }) => [
  ...
  test("BigInt is not supported yet", [
    ...
    `).newErrors(
        `
          test.js:8
            8:       const valid_neg_binary = -0b101011101n;
                                              ^^^^^^^^^^^^^ bigint [1] is not a number. [incompatible-use]
            References:
              8:       const valid_neg_binary = -0b101011101n;
                                                 ^^^^^^^^^^^^ [1]
          test.js:13
           13:       const valid_neg_hex = -0xfff123n;
                                           ^^^^^^^^^^ bigint [1] is not a number. [incompatible-use]
            References:
             13:       const valid_neg_hex = -0xfff123n;
                                              ^^^^^^^^^ [1]
          test.js:18
           18:       const valid_neg_large = -9223372036854775807n;
                                             ^^^^^^^^^^^^^^^^^^^^^ bigint [1] is not a number. [incompatible-use]
            References:
             18:       const valid_neg_large = -9223372036854775807n;
                                                ^^^^^^^^^^^^^^^^^^^^ [1]
          test.js:23
           23:       const valid_neg_octal_new = -0o16432n;
                                                 ^^^^^^^^^ bigint [1] is not a number. [incompatible-use]
            References:
             23:       const valid_neg_octal_new = -0o16432n;
                                                    ^^^^^^^^ [1]
          test.js:28
           28:       const valid_neg_small = -100n;
                                             ^^^^^ bigint [1] is not a number. [incompatible-use]
            References:
             28:       const valid_neg_small = -100n;
                                                ^^^^ [1]
