...
export default suite(({ideStart, ideNotification, ideRequest, addCode, addFile, addFiles}) => [
  ...
  test('Non-local suppressions behavior', [
    addFiles('dependencyWithSuppression.js', 'fileWithNonLocalError.js')
      .ideStart({mode:'legacy'})
      .ideNotification('subscribeToDiagnostics')
      .waitAndVerifyAllIDEMessagesContentSinceStartOfStep(
        10000,
      ...
      .because('error should be suppressed'),
  ]),
