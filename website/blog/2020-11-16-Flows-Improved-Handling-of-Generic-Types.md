...
:::info[Historical]
This post announced improved handling of generic types when it was introduced. For current syntax and behavior, see the [Generics](/en/docs/types/generics) documentation.
:::
