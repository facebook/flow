...
:::info[Historical]
This post announced improved error messages when it was introduced. For current syntax and behavior, see the [Error Messages](/en/docs/errors) documentation.
:::
