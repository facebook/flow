...
:::info[Historical]
This post announced TypeScript Enums vs. Flow Enums when it was introduced. For current syntax and behavior, see the [Flow Enums](/en/docs/enums) documentation.
:::
