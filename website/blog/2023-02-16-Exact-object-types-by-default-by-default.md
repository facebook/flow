...
:::info[Historical]
This post announced exact object types becoming the default when it was introduced. For current syntax and behavior, see the [Objects](/en/docs/types/objects) documentation.
:::
