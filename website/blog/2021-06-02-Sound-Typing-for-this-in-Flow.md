...
:::info[Historical]
This post announced sound typing for `this` when it was introduced. For current syntax and behavior, see the [Functions](/en/docs/types/functions) documentation.
:::
