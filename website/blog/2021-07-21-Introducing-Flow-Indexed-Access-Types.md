...
:::info[Historical]
This post announced indexed access types when it was introduced. For current syntax and behavior, see the [Indexed Access Types](/en/docs/types/indexed-access) documentation.
:::
