...
:::info[Historical]
This post announced required annotations when it was introduced. For current syntax and behavior, see the [Annotation Requirement](/en/docs/lang/annotation-requirement) documentation.
:::
