...
:::info[Historical]
This post announced the `as` type casting syntax when it was introduced. For current syntax and behavior, see the [Type Casting](/en/docs/types/casting) documentation.
:::
