...
:::info[Historical]
This post announced opaque type aliases when it was introduced. For current syntax and behavior, see the [Opaque Types](/en/docs/types/opaque-types) documentation.
:::
