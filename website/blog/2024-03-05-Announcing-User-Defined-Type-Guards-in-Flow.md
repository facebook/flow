...
:::info[Historical]
This post announced user-defined type guards when it was introduced. For current syntax and behavior, see the [Type Guards](/en/docs/types/type-guards) documentation.
:::
