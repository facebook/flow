...
:::info[Historical]
This post announced changes to object spreads when it was introduced. For current syntax and behavior, see the [Objects](/en/docs/types/objects) documentation.
:::
