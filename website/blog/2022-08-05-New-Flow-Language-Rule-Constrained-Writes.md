...
:::info[Historical]
This post announced the constrained writes rule when it was introduced. For current syntax and behavior, see the [Variables](/en/docs/lang/variables) documentation.
:::
