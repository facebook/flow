...
:::info[Historical]
This post announced conditional types when it was introduced. For current syntax and behavior, see the [Conditional Types](/en/docs/types/conditional) documentation.
:::
