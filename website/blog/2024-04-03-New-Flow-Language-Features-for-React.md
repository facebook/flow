...
:::info[Historical]
This post announced component and hook syntax for React when it was introduced. For current syntax and behavior, see the [Component Syntax](/en/docs/react/component-syntax) and [Hook Syntax](/en/docs/react/hook-syntax) documentation.
:::
