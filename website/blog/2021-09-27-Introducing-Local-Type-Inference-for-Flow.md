...
:::info[Historical]
This post announced local type inference when it was introduced. For current syntax and behavior, see the [Annotation Requirement](/en/docs/lang/annotation-requirement) documentation.
:::
