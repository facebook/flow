...
> For files in your project without this flag, the Flow background process skips and ignores the code (unless you set the `all` option in `.flowconfig`, which is beyond the scope of basic usage).
