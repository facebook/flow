...
integration](https://nuclide.io/blog/2017/09/12/Introducing-Atom-IDE-UI/) into the
[Atom IDE](https://ide.atom.io/) initiative.
...
Note that if you’re already a Nuclide user, all of Atom IDE UI’s features will still
be bundled inside of Nuclide, so there’s no need to install another package.
