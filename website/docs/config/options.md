...
* [`use_mixed_in_catch_variables`](#toc-use-mixed-in-catch-variables)
...
#### `inference_mode` _`(classic | constrain-writes)`_ <SinceVersion version="0.184.0" /> {#toc-inference-mode-classic-constrain-writes}
...
#### `use_mixed_in_catch_variables` _`(boolean)`_ <SinceVersion version="0.201" /> {#toc-use-mixed-in-catch-variables}
