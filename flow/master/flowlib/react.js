...
declare namespace React {
   ...
   * @flowCustomError
   */
  type MixedElement = ExactReactElement_DEPRECATED<React$ElementType, mixed>;
  ...
  type ElementRef<C: string | component(...empty)> =
    ...
    C extends component(...infer Props extends {...})
      ? ('ref' extends $Keys<Props>
        ? (Props extends {+ref?: RefSetter<infer I>, ...} ? I : mixed)
        : void
      )
      : empty;
   ...
   * @deprecated TypeScript compatibility alias. Use `React.RefSetter` instead.
   */
  type RefCallback<T> = (T | null) => mixed;
  /**
   * @deprecated TypeScript compatibility alias.
   */
   ...
   * @deprecated TypeScript compatibility alias.
   */
  type DependencyList = $ReadOnlyArray<mixed>;
  /**
   * @deprecated TypeScript compatibility alias.
   */
...
type React$CloneElement =
  & (<C: $Keys<$JSXIntrinsics>, E: ExactReactElement_DEPRECATED<C>>(
    element: E,
...
declare module "react" {
   ...
   * @deprecated TypeScript compatibility alias. Use `React.RefSetter` instead.
   */
  declare export type RefCallback<T> = (T | null) => mixed;
  /**
   * @deprecated TypeScript compatibility alias.
   */
   ...
   * @deprecated TypeScript compatibility alias.
   */
  declare export type DependencyList = $ReadOnlyArray<mixed>;
  /**
   * @deprecated TypeScript compatibility alias.
   */
  ...
  declare namespace React {
     ...
     * [create a stable event function with the latest values that can be called in Effects](https://react.dev/learn/separating-events-from-effects)
     */
    declare hook useEffectEvent<F: (...empty) => mixed>(
      callback: F,
    ): F;
