...
val error_of_package_json_error : source_file: File_key.t -> Loc.t * string -> ALoc.t Errors.error
val set_of_package_json_error: source_file: File_key.t -> Loc.t * string -> Errors.ErrorSet.t
