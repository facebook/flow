...
let tests =
  ...
  >::: [
         ...
         ( "offset_line_after_multibyte_char"
         >:: (fun ctxt -> run ctxt str_with_smiley (2, 0) (13, 11)) );
         ( "offset_of_multi_unit_utf16_char"
         >:: (fun ctxt -> run ctxt str_with_utf16_edge_cases (1, 4) (4, 4)) );
         ( "offset_after_multi_unit_utf16_char"
         >:: (fun ctxt -> run ctxt str_with_utf16_edge_cases (1, 5) (8, 6)) );
         ( "offset_of_single_unit_utf16_char"
         >:: (fun ctxt -> run ctxt str_with_utf16_edge_cases (1, 10) (13, 11)) );
         ( "offset_after_single_unit_utf16_char"
         >:: (fun ctxt -> run ctxt str_with_utf16_edge_cases (1, 11) (16, 12)) );
         ( "offset_of_single_unit_utf16_char2"
         >:: (fun ctxt -> run ctxt str_with_utf16_edge_cases (1, 16) (21, 17)) );
         ( "offset_after_single_unit_utf16_char2"
         >:: (fun ctxt -> run ctxt str_with_utf16_edge_cases (1, 17) (24, 18)) );
         ( "out_of_bounds_line"
         >:: fun _ctxt ->
