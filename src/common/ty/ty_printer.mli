...
val string_of_elt :
  ?prefer_single_quotes:bool -> ?with_comments:bool -> ts_syntax:bool -> Ty.elt -> string

val string_of_elt_single_line :
  ?prefer_single_quotes:bool -> ?with_comments:bool -> ts_syntax:bool -> Ty.elt -> string

val string_of_decl_single_line :
  ?prefer_single_quotes:bool -> ?with_comments:bool -> ts_syntax:bool -> Ty.decl -> string

val string_of_t :
  ?prefer_single_quotes:bool -> ?with_comments:bool -> ts_syntax:bool -> Ty.t -> string
