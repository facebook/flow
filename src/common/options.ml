...
type t = {
  ...
  opt_lazy_mode: bool;
  opt_linked_editing_range_optimizations: bool;
  ...
  opt_natural_inference_object_freeze: bool;
...
let linked_editing_range_optimizations opts = opts.opt_linked_editing_range_optimizations
...
let natural_inference_object_freeze opts = opts.opt_natural_inference_object_freeze
