...
type t = {
  ...
  opt_async_component_syntax_includes: Str.regexp list;
...
let async_component_syntax_includes opts = opts.opt_async_component_syntax_includes
...
let ts_utility_syntax _opts = true
