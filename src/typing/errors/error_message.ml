...
and 'loc t' =
  ...
  | EExperimentalNullishCoalescing of 'loc
...
let map_loc_of_error_message (f : 'a -> 'b) : 'a t' -> 'b t' =
  ...
  | EExperimentalNullishCoalescing loc -> EExperimentalNullishCoalescing (f loc)
...
| EExperimentalNullishCoalescing _
...
let aloc_of_msg : t -> ALoc.t option = function
  ...
  | EExperimentalNullishCoalescing loc
...
let friendly_message_of_msg : Loc.t t' -> Loc.t friendly_message_recipe =
  ...
  Errors.(function
    ...
    | EExperimentalNullishCoalescing _ ->
      Normal [
        text "Experimental nullish coalescing ("; code "??"; text ") usage. ";
        text "Nullish coalescing is an active early-stage feature proposal that ";
        text "may change. You may opt in to using it anyway by putting ";
        code "esproposal.nullish_coalescing=enable"; text " into the ";
        code "[options]"; text " section of your "; code ".flowconfig"; text ".";
      ]
