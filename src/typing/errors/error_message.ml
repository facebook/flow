...
and 'loc t' =
  ...
  | EUnsupportedUnionObj of ('loc virtual_reason * 'loc virtual_reason)
...
let map_loc_of_error_message (f : 'a -> 'b) : 'a t' -> 'b t' =
  ...
  | EUnsupportedUnionObj (r1, r2) -> EUnsupportedUnionObj (map_reason r1, map_reason r2)
