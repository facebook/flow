...
type metadata = {
  ...
  natural_inference_object_literal_followup_fix_excludes: Str.regexp list;
...
let metadata_of_options options =
  {
    ...
    invariant_subtyping_error_message_improvement =
      Options.invariant_subtyping_error_message_improvement options;
    ...
    natural_inference_object_literal_followup_fix =
      Options.natural_inference_object_literal_followup_fix options;
    natural_inference_object_literal_followup_fix_excludes =
      Options.natural_inference_object_literal_followup_fix_excludes options;
...
let natural_inference_object_literal_followup_fix cx =
  cx.metadata.natural_inference_object_literal_followup_fix
  && not (in_dirlist cx cx.metadata.natural_inference_object_literal_followup_fix_excludes)
