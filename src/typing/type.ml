...
module rec TypeTerm : sig
  ...
  type t =
    ...
    (* Object singleton *)
    | ObjectSingletonT of reason * t * t
  ...
  and use_t =
    ...
    **)
    ...
    | MakeObjectSingletonT of reason * cont * t (* value *)
...
and TypeUtil : sig
  ...
  let rec reason_of_t = function
    ...
    | ObjectSingletonT (reason, _, _) -> reason
  ...
  and reason_of_use_t = function
    ...
    | MakeObjectSingletonT (reason, _, _) -> reason
  ...
  let rec mod_reason_of_t f = function
    ...
    | ObjectSingletonT (reason, t1, t2) -> ObjectSingletonT (f reason, t1, t2)
  ...
  and mod_reason_of_use_t f = function
    ...
    | MakeObjectSingletonT (reason, t, t2) -> MakeObjectSingletonT (f reason, t, t2)
