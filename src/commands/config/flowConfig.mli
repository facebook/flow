...
val max_workers_down_scaling_factor : config -> int
...
val natural_inference_object_literal_followup_fix : config -> bool

val natural_inference_object_literal_followup_fix_excludes : config -> string list
