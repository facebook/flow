...
class mapper = object(this)
  ...
  method array (expr: (Loc.t, Loc.t) Ast.Expression.Array.t) =
    let open Ast.Expression in
  ...
  method arrow_function (expr: (Loc.t, Loc.t) Ast.Function.t) =
    this#function_ expr
  ...
  method optional_call loc (expr: (Loc.t, Loc.t) Ast.Expression.OptionalCall.t) =
  ...
  method class_body (cls_body: (Loc.t, Loc.t) Ast.Class.Body.t) =
  ...
  method class_property (prop: (Loc.t, Loc.t) Ast.Class.Property.t') =
  ...
  method class_private_field (prop: (Loc.t, Loc.t) Ast.Class.PrivateField.t') =
  ...
  (* TODO *)
  method comprehension (expr: (Loc.t, Loc.t) Ast.Expression.Comprehension.t) = expr
  ...
  method declare_export_declaration _loc (decl: (Loc.t, Loc.t) Ast.Statement.DeclareExportDeclaration.t) =
  ...
  method declare_export_declaration_decl (decl: (Loc.t, Loc.t) Ast.Statement.DeclareExportDeclaration.declaration) =
    decl
  ...
  method declare_interface (decl: (Loc.t, Loc.t) Ast.Statement.Interface.t) =
    this#interface decl
  ...
  (* TODO *)
  method declare_module_exports _loc (annot: (Loc.t, Loc.t) Ast.Type.annotation) =
    annot

  method declare_type_alias (decl: (Loc.t, Loc.t) Ast.Statement.TypeAlias.t) =
  ...
  method do_while (stuff: (Loc.t, Loc.t) Ast.Statement.DoWhile.t) =
  ...
  method export_default_declaration _loc (decl: (Loc.t, Loc.t) Ast.Statement.ExportDefaultDeclaration.t) =
  ...
  method export_default_declaration_decl (decl: (Loc.t, Loc.t) Ast.Statement.ExportDefaultDeclaration.declaration) =
    let open Ast.Statement.ExportDefaultDeclaration in
    match decl with
  ...
  method export_named_declaration _loc (decl: (Loc.t, Loc.t) Ast.Statement.ExportNamedDeclaration.t) =
  ...
  method expression_statement (stmt: (Loc.t, Loc.t) Ast.Statement.Expression.t) =
  ...
  method for_of_statement (stuff: (Loc.t, Loc.t) Ast.Statement.ForOf.t) =
  ...
  method for_statement_init (init: (Loc.t, Loc.t) Ast.Statement.For.init) =
    let open Ast.Statement.For in
    match init with
  ...
  method function_rest_param_type (frpt: (Loc.t, Loc.t) Ast.Type.Function.RestParam.t) =
  ...
  method function_type (ft: (Loc.t, Loc.t) Ast.Type.Function.t) =
  ...
  method object_property_value_type (opvt: (Loc.t, Loc.t) Ast.Type.Object.Property.value) =
  ...
  method object_spread_property_type (opt: (Loc.t, Loc.t) Ast.Type.Object.SpreadProperty.t) =
  ...
  method object_type (ot: (Loc.t, Loc.t) Ast.Type.Object.t) =
  ...
  method interface_type (i: (Loc.t, Loc.t) Ast.Type.Interface.t) =
  ...
  method type_parameter_instantiation (pi: (Loc.t, Loc.t) Ast.Type.ParameterInstantiation.t) =
    let loc, targs = pi in
    let targs' = ListUtils.ident_map this#type_ targs in
    if targs' == targs then pi
    else loc, targs'

  method type_parameter_declaration (pd: (Loc.t, Loc.t) Ast.Type.ParameterDeclaration.t) =
  ...
  method type_parameter_declaration_type_param (type_param: (Loc.t, Loc.t) Ast.Type.ParameterDeclaration.TypeParam.t) =
  ...
  method generic_type (gt: (Loc.t, Loc.t) Ast.Type.Generic.t) =
  ...
  method function_params (params: (Loc.t, Loc.t) Ast.Function.Params.t) =
    let open Ast.Function in
  ...
  method function_param_patterns (params_list: (Loc.t, Loc.t) Ast.Pattern.t list) =
    ListUtils.ident_map this#function_param_pattern params_list

  method function_body_any (body: (Loc.t, Loc.t) Ast.Function.body) =
    match body with
  ...
  method function_body (block: (Loc.t, Loc.t) Ast.Statement.Block.t) =
    this#block block
  ...
  method function_declaration (stmt: (Loc.t, Loc.t) Ast.Function.t) =
    this#function_ stmt

  (* TODO *)
  method generator (expr: (Loc.t, Loc.t) Ast.Expression.Generator.t) = expr
  ...
  method interface_declaration (decl: (Loc.t, Loc.t) Ast.Statement.Interface.t) =
    this#interface decl

  method private_name (expr: Loc.t Ast.PrivateName.t) = expr

  method import _loc (expr: (Loc.t, Loc.t) Ast.Expression.t) = expr

  method if_consequent_statement ~has_else (stmt: (Loc.t, Loc.t) Ast.Statement.t) =
    ignore has_else;
    this#statement stmt
  ...
  method jsx_element (expr: (Loc.t, Loc.t) Ast.JSX.element) =
    let open Ast.JSX in
  ...
  method jsx_fragment (expr: (Loc.t, Loc.t) Ast.JSX.fragment) =
    let open Ast.JSX in
  ...
  method jsx_opening_attribute (jsx_attr: (Loc.t, Loc.t) Ast.JSX.Opening.attribute) =
    let open Ast.JSX.Opening in
    match jsx_attr with
    | Attribute attr ->
  ...
  method jsx_spread_attribute (attr: (Loc.t, Loc.t) Ast.JSX.SpreadAttribute.t') =
  ...
  method jsx_attribute_value (value: (Loc.t, Loc.t) Ast.JSX.Attribute.value) =
    let open Ast.JSX.Attribute in
    match value with
    | Literal _ -> value
  ...
  method jsx_expression (jsx_expr: (Loc.t, Loc.t) Ast.JSX.ExpressionContainer.t) =
  ...
  method optional_member (expr: (Loc.t, Loc.t) Ast.Expression.OptionalMember.t) =
  ...
  method member_property (expr: (Loc.t, Loc.t) Ast.Expression.Member.property) =
    let open Ast.Expression.Member in
    match expr with
  ...
  method member_property_expression (expr: (Loc.t, Loc.t) Ast.Expression.t) =
    this#expression expr

  (* TODO *)
  method meta_property (expr: Loc.t Ast.Expression.MetaProperty.t) = expr

  method new_ (expr: (Loc.t, Loc.t) Ast.Expression.New.t) =
  ...
  method object_ (expr: (Loc.t, Loc.t) Ast.Expression.Object.t) =
  ...
  method catch_clause_pattern (expr: (Loc.t, Loc.t) Ast.Pattern.t) =
    this#binding_pattern ~kind:Ast.Statement.VariableDeclaration.Let expr

  method for_in_assignment_pattern (expr: (Loc.t, Loc.t) Ast.Pattern.t) =
    this#assignment_pattern expr

  method for_of_assignment_pattern (expr: (Loc.t, Loc.t) Ast.Pattern.t) =
    this#assignment_pattern expr

  method binding_pattern ?(kind=Ast.Statement.VariableDeclaration.Var) (expr: (Loc.t, Loc.t) Ast.Pattern.t) =
    this#pattern ~kind expr

  method assignment_pattern (expr: (Loc.t, Loc.t) Ast.Pattern.t) =
    this#pattern expr
  ...
  method pattern_object_p ?kind (p: (Loc.t, Loc.t) Ast.Pattern.Object.property) =
  ...
  method pattern_object_property_key ?kind (key: (Loc.t, Loc.t) Ast.Pattern.Object.Property.key) =
    let open Ast.Pattern.Object.Property in
    match key with
    | Literal (loc, lit) ->
  ...
  method pattern_object_property_computed_key ?kind (key: (Loc.t, Loc.t) Ast.Expression.t) =
    ignore kind;
    this#pattern_expression key

  method pattern_object_rest_property ?kind (prop: (Loc.t, Loc.t) Ast.Pattern.Object.RestProperty.t') =
  ...
  method pattern_object_property_pattern ?kind (expr: (Loc.t, Loc.t) Ast.Pattern.t) =
    this#pattern ?kind expr

  method pattern_object_rest_property_pattern ?kind (expr: (Loc.t, Loc.t) Ast.Pattern.t) =
    this#pattern ?kind expr

  method pattern_array_e ?kind (e: (Loc.t, Loc.t) Ast.Pattern.Array.element) =
  ...
  method pattern_array_element_pattern ?kind (expr: (Loc.t, Loc.t) Ast.Pattern.t) =
    this#pattern ?kind expr

  method pattern_array_rest_element ?kind (elem: (Loc.t, Loc.t) Ast.Pattern.Array.RestElement.t') =
  ...
  method pattern_array_rest_element_pattern ?kind (expr: (Loc.t, Loc.t) Ast.Pattern.t) =
    this#pattern ?kind expr

  method pattern_assignment_pattern ?kind (expr: (Loc.t, Loc.t) Ast.Pattern.t) =
    this#pattern ?kind expr

  method pattern_expression (expr: (Loc.t, Loc.t) Ast.Expression.t) =
    this#expression expr

  method predicate_expression (expr: (Loc.t, Loc.t) Ast.Expression.t) =
    this#expression expr

  (* TODO *)
  method function_rest_element (expr: (Loc.t, Loc.t) Ast.Function.RestElement.t) = expr
  ...
  method sequence (expr: (Loc.t, Loc.t) Ast.Expression.Sequence.t) =
  ...
  method spread_element (expr: (Loc.t, Loc.t) Ast.Expression.SpreadElement.t) =
  ...
  method spread_property (expr: (Loc.t, Loc.t) Ast.Expression.Object.SpreadProperty.t) =
  ...
  method switch_case (case: (Loc.t, Loc.t) Ast.Statement.Switch.Case.t') =
  ...
  method tagged_template (expr: (Loc.t, Loc.t) Ast.Expression.TaggedTemplate.t) =
  ...
  method template_literal (expr: (Loc.t, Loc.t) Ast.Expression.TemplateLiteral.t) =
  ...
  method type_cast (expr: (Loc.t, Loc.t) Ast.Expression.TypeCast.t) =
  ...
  method unary_expression (expr: (Loc.t, Loc.t) Ast.Expression.Unary.t) =
    let open Ast.Expression in
  ...
  method while_ (stuff: (Loc.t, Loc.t) Ast.Statement.While.t) =
  ...
  (* TODO *)
  method yield (expr: (Loc.t, Loc.t) Ast.Expression.Yield.t) = expr
