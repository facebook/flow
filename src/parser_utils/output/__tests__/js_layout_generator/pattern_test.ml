...
let tests =
  [
    ...
    ( "let_object_multiple_vars_aliased"
    >:: fun ctxt ->
    ...
    ( "let_array_optional_annotated_item"
    >:: (fun ctxt -> assert_statement_string ~ctxt "let[a?:b]=a;") );
    ( "let_array_multiple_items"
    >:: fun ctxt ->
    assert_statement_string ~ctxt "let[a,b]=a;";
    assert_statement_string ~ctxt ~pretty:true "let [a, b] = a;" );
    ( "let_array_holes"
