  ...
  *)
  ...
  and export_specifier
    ...
    let ( _,
      ...
      spec2
    in
    if export_kind1 <> export_kind2 then
      None
    else
  ...
  and declare_variable
    ...
    let { declarations = declarations1; kind = kind1; comments = comments1 } = decl1 in
    let { declarations = declarations2; kind = kind2; comments = comments2 } = decl2 in
    if kind1 != kind2 then
      None
    else
      let declarations_diff =
