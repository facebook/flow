...
class virtual ['M, 'T, 'N, 'U] mapper :
  object
    ...
    method class_abstract_property :
      ('M, 'T) Ast.Class.AbstractProperty.t' -> ('N, 'U) Ast.Class.AbstractProperty.t'
    ...
    method enum_member_name :
      'M Ast.Statement.EnumDeclaration.member_name -> 'N Ast.Statement.EnumDeclaration.member_name
    ...
    method record_body :
      ('M, 'T) Ast.Statement.RecordDeclaration.Body.t ->
      ('N, 'U) Ast.Statement.RecordDeclaration.Body.t

    method record_element :
    ...
    method template_literal_type :
      ('M, 'T) Ast.Type.TemplateLiteral.t -> ('N, 'U) Ast.Type.TemplateLiteral.t
    ...
    method type_param_identifier : ('M, 'T) Ast.Identifier.t -> ('N, 'U) Ast.Identifier.t
    ...
    method ts_accessibility : 'M Ast.Class.TSAccessibility.t' -> 'N Ast.Class.TSAccessibility.t'
