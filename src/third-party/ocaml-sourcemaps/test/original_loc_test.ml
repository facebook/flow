...
let bar = Sourcemap.{ source = "bar.js"; original_loc = { line = 1; col = 1 }; name = None }
let foo = Sourcemap.{ source = "foo.js"; original_loc = { line = 1; col = 1 }; name = None }
