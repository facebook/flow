...
let v3_source = "a\n\nb"
let v1_a = Sourcemap.{ source = "v1.js"; original_loc = { line = 1; col = 0 }; name = Some "a" }
let v1_b = Sourcemap.{ source = "v1.js"; original_loc = { line = 2; col = 0 }; name = Some "b" }
let v2_a = Sourcemap.{ source = "v2.js"; original_loc = { line = 2; col = 0 }; name = Some "A" }
let v2_b = Sourcemap.{ source = "v2.js"; original_loc = { line = 1; col = 2 }; name = Some "B" }
let v3_a = Sourcemap.{ source = "v3.js"; original_loc = { line = 1; col = 0 }; name = Some "a" }
let v3_b = Sourcemap.{ source = "v3.js"; original_loc = { line = 3; col = 0 }; name = Some "b" }
...
let tests =
  ...
  >::: [
         ...
         ( "empty_map_2_3" >:: fun ctxt ->
           let expected = Sourcemap.create () ~file:"v3.js" ~source_root:"/v1_files/" in
           let map_2_3 = Sourcemap.create () ~file:"v3.js" ~source_root:"/v2_files/" in
           let map_1_3 = Sourcemap.compose map_2_3 map_1_2 in
           assert_equal_sourcemaps ~ctxt expected map_1_3
         );
         ( "empty_map_1_2" >:: fun ctxt ->
           let expected = Sourcemap.create () ~file:"v3.js" ~source_root:"/v1_files/" in
