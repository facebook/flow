...
(* We should revisit this function for perf reasons
   This function produce Node of
*)
let create l v r =
  let hl = height l in
  let hr = height r in
