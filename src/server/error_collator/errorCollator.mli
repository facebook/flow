...
(* Update timestamp_start_of_non_zero_errors, and return time to resolve all errors. *)
val update_timestamp_start_of_non_zero_errors :
  Collated_errors.t -> Collated_errors.t * float option
