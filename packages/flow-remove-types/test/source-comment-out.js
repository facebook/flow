...
import {
  Something,
  type SomeType1,
  typeof SomeOtherThing1,
} from 'some-module';

// Regular import with types only
import {
  type SomeType2,
  typeof SomeOtherThing2,
} from 'some-module';

// Mixed default and named type only imports
import DefaultImport, {
  type SomeType3,
  typeof SomeOtherThing3,
} from 'some-module';

// Import types
import type { SomeType4 } from 'some-module';
...
// Example from README
import SomeClass2 from 'some-module'
import type { SomeInterface } from 'some-module'

export class MyClass<T> extends SomeClass2 implements SomeInterface {
