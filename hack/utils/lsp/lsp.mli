...
module Location : sig type t = { uri : documentUri; range : range; } end
module DefinitionLocation :
  sig type t = { location : Location.t; title : string option; } end
type markedString = MarkedString of string | MarkedCode of string * string
module Command : sig
  type t = {
...
module TextEdit : sig type t = { range : range; newText : string; } end
module TextDocumentIdentifier : sig type t = { uri : documentUri; } end
module VersionedTextDocumentIdentifier :
  sig type t = { uri : documentUri; version : int; } end
...
module DocumentSelector : sig type t = DocumentFilter.t list end
...
module Initialize :
  sig
    ...
    and trace = Off | Messages | Verbose
    ...
    and server_capabilities = {
      ...
      documentOnTypeFormattingProvider :
        documentOnTypeFormattingOptions option;
      renameProvider : bool;
    ...
    and textDocumentSyncKind = NoSync | FullSync | IncrementalSync
...
module DocumentHighlight :
  sig
    ...
    and documentHighlightKind = Text | Read | Write
  end
module TypeCoverage :
  sig
    ...
    and uncoveredRange = { range : range; message : string option; }
  end
module DocumentFormatting :
  sig
    ...
    and formattingOptions = { tabSize : int; insertSpaces : bool; }
  end
...
module LogMessage :
  sig
    ...
    and logMessageParams = { type_ : MessageType.t; message : string; }
  end
module ShowMessage :
  sig
    type params = showMessageParams
    and showMessageParams = { type_ : MessageType.t; message : string; }
  end
...
module Progress :
  sig
    ...
    and progressParams = { id : int; label : string option; }
  end
module ActionRequired :
  sig
    type t = Present of { id : int; label : string; } | Absent
    and params = actionRequiredParams
    and actionRequiredParams = { id : int; label : string option; }
  end
...
module IdSet : sig include module type of Set.Make (IdKey) end
module IdMap : sig include module type of MyMap.Make (IdKey) end
