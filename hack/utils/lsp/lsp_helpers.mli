...
val update_diagnostics_due_to_change :
  ...
  Lsp.DidChange.params -> Lsp.PublishDiagnostics.diagnostic list
...
val notify_progress_raw : 'a ->
Lsp.Initialize.params ->
('a -> Lsp.Progress.params -> 'a) ->
Lsp.Progress.t -> string option -> 'a * Lsp.Progress.t
val notify_progress : Lsp.Initialize.params ->
Jsonrpc.writer -> Lsp.Progress.t -> string option -> Lsp.Progress.t
