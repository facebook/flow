...
declare class net$Socket extends stream$Duplex {
  constructor(options?: net$socketOptions): void;
  address(): net$Socket$address;
  bufferSize: number;
  bytesRead: number;
  bytesWritten: number;
  connect(options: net$connectOptions, connectListener?: net$connectListener): this;
  connect(path: string, connectListener?: net$connectListener): this;
  connect(port: number, host?: string, connectListener?: net$connectListener): this;
  connect(port: number, connectListener?: net$connectListener): this;
  connecting: boolean;
...
declare class net$Server extends events$EventEmitter {
  constructor(connectionListener: net$connectionListener): void;
  constructor(options?: net$serverOptions, connectionListener?: net$connectionListener): void;
  listen(options: net$listenOptions, callback?: Function): this;
  listen(callback?: Function): this;
  listen(port: number, callback?: Function): this;
  listen(port: number, host?: string, callback?: Function): this;
  listen(port: number, host?: string, backlog?: number, callback?: Function): this;
  listen(path: string, backlog?: number, callback?: Function): this;
  listen(path: string, callback?: Function): this;
  listen(handle: Object, backlog?: number, callback?: Function): this;
  ...
  getConnections(callback: (err: ?Error, count?: number) => any): void;
  ref(): this;
  unref(): this;
}
...
type net$connectionListener = (socket: net$Socket) => any;
...
type net$connectListener = () => any;

type net$serverOptions = {
  allowHalfOpen?: boolean,
  pauseOnConnect?: boolean
};

type net$socketOptions = {
  fd?: number,
  allowHalfOpen?: boolean,
  readable?: boolean,
  writable?: boolean
...
declare module "net" {
  ...
  declare function createServer(
    connectionListener: net$connectionListener
  ): Server;
  declare function createServer(
  ...
  declare function connect(options: net$connectOptions, connectListener?: net$connectListener): Socket;
  declare function connect(path: string, connectListener?: net$connectListener): Socket;
  declare function connect(port: number, host?: string, connectListener?: net$connectListener): Socket;
  declare function connect(port: number, connectListener?: net$connectListener): Socket;

  declare function createConnection(options: net$connectOptions, connectListener?: net$connectListener): Socket;
  declare function createConnection(path: string, connectListener?: net$connectListener): Socket;
  declare function createConnection(port: number, host?: string, connectListener?: net$connectListener): Socket;
  declare function createConnection(port: number, connectListener?: net$connectListener): Socket;
}
