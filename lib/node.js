...
declare class http$Agent<SocketT> {
  constructor(options: http$agentOptions): void;
  destroy(): void;
  freeSockets: {[name: string]: Array<SocketT>};
  getName(options: {host: string, port: number, localAddress: string}): string;
  maxFreeSockets: number;
  maxSockets: number;
  requests: {[name: string]: Array<http$ClientRequest<SocketT>>};
  sockets: {[name: string]: Array<SocketT>};
}

declare class http$IncomingMessage<SocketT> extends stream$Readable {
...
declare class http$ClientRequest<SocketT> extends stream$Writable {
  abort(): void;
  aborted: boolean;
