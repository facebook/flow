...
declare module "util" {
  declare export function debuglog(section: string): (data: any, ...args: any) => void;
  declare export function format(format: string, ...placeholders: any): string;
  declare export function log(string: string): void;
  declare export function inspect(object: any, options?: util$InspectOptions): string;
  ...
  declare export function inherits(constructor: Function, superConstructor: Function): void;
  declare export function deprecate(f: Function, string: string): Function;
