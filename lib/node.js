...
declare module "fs" {
  ...
  declare function stat(path: string, callback: (err: ?Error, stats: Stats) => void): void;
  declare function stat(path: string): Stats;
  ...
  declare function write(
    ...
    offset: number,
    length: number,
    position?: callback: (err: ?Error, write: number, str: string) => void
  ): void;
  declare function write(
    fd: number,
    data: mixed,
  ...
  declare function read(
    ...
    length: number,
    position: ?number,
    callback: (err: ?Error, bytesRead: number, buffer: Buffer)
  ): void;
