...
// deprecated
type crypto$createCredentialsDetails = {
  pfx: string,
  key: string,
  passphrase: string,
  cert: string,
...
type crypto$SignPrivateKeyInput = crypto$PrivateKeyInput & {
  padding?:
    | typeof crypto$constants.RSA_PKCS1_PADDING
    | typeof crypto$constants.RSA_PKCS1_PSS_PADDING,
  saltLength?: number,
  ...
};
...
declare class crypto$Cipher extends stream$Duplex {
  ...
  getAuthTag(): Buffer;
  setAAD(buffer: Buffer, options?: { plaintextLength: number }): crypto$Cipher;
  setAuthTag(buffer: Buffer): void;
  setAutoPadding(auto_padding?: boolean): crypto$Cipher;
  update(data: string | Buffer | $TypedArray | DataView): Buffer;
  update(
    data: string,
...
type crypto$DiffieHellman = {
  ...
  computeSecret(other_public_key: Buffer | $TypedArray | DataView, output_encoding: string): string;
  ...
  setPublicKey(public_key: Buffer | $TypedArray | DataView): void,
...
type crypto$ECDH$Format = 'compressed' | 'uncompressed' | 'hybrid';

declare class crypto$ECDH {
  static convertKey(
    key: string | Buffer | $TypedArray | DataView,
    curve: string,
    inputEncoding?: crypto$ECDH$Encoding,
    outputEncoding?: crypto$ECDH$Encoding,
...
declare class crypto$Decipher extends stream$Duplex {
  ...
  final(output_encoding: void): Buffer;
  getAuthTag(): Buffer;
  setAAD(buffer: Buffer, options?: { plaintextLength: number }): void;
  setAuthTag(buffer: Buffer): void;
  setAutoPadding(auto_padding?: boolean): crypto$Cipher;
  update(data: string | Buffer | $TypedArray | DataView): Buffer;
  update(
...
type crypto$Verify$object = crypto$PublicKeyInput & {
  padding?:
    | typeof crypto$constants.RSA_PKCS1_PADDING
    | typeof crypto$constants.RSA_PKCS1_PSS_PADDING,
  saltLength?: number,
...
declare class crypto$Verify extends stream$Writable {
  ...
  verify(
    object: crypto$Verify$object | string | Buffer | crypto$KeyObject,
    signature: Buffer | $TypedArray | DataView,
    signature_format: void
  ): boolean;
  verify(
    object: crypto$Verify$object | string | Buffer | crypto$KeyObject,
    signature: string,
...
type crypto$RsaPublicKey = {
  key: string | Buffer,
  padding?:
    | typeof crypto$constants.RSA_NO_PADDING
    | typeof crypto$constants.RSA_PKCS1_PADDING
    | typeof crypto$constants.RSA_PKCS1_OAEP_PADDING,,
  ...
};

type crypto$RsaPrivateKey = {
  key: string | Buffer,
  passphrase?: string | Buffer,
  padding?:
    | typeof crypto$constants.RSA_NO_PADDING
...
type crypto$KeyType = 'rsa' | 'dsa' | 'ec';
type crypto$KeyFormat = 'pem' | 'der';

type crypto$BasePrivateKeyEncodingOptions<T: crypto$KeyFormat> = {
  format: T,
  cipher: string,
  passphrase: string,
  ...
...
type crypto$KeyExportOptions<T: crypto$KeyFormat> = {
...
type crypto$KeyPairKeyObjectResult = {
  publicKey: crypto$KeyObject,
  privateKey: crypto$KeyObject,
  ...
}

type crypto$ECKeyPairKeyObjectOptions = {
  /**
...
type crypto$RSAKeyPairKeyObjectOptions = {
  /**
   * Key size in bits
   */
...
type crypto$DSAKeyPairKeyObjectOptions = {
  /**
   * Key size in bits
   */
  modulusLength: number,
...
type crypto$RSAKeyPairOptions<
  PubF: crypto$KeyFormat,
...
> = {
  ...
  privateKeyEncoding: crypto$BasePrivateKeyEncodingOptions<PrivF> & {
    type: 'pkcs1' | 'pkcs8',
    ...
  },
  ...
...
type crypto$ECKeyPairOptions<PubF: crypto$KeyFormat, PrivF: crypto$KeyFormat> = {
  /**
   * Name of the curve to use.
   */
  namedCurve: string,
...
type crypto$KeyPairSyncResult<T1: string | Buffer, T2: string | Buffer> = {
  publicKey: T1,
  privateKey: T2,
  ...
}
...
declare class crypto$KeyObject {
  asymmetricKeyType?: crypto$KeyType;
  export(options: crypto$KeyExportOptions<'pem'>): string | Buffer;
  export(options?: crypto$KeyExportOptions<'der'>): Buffer;
  symmetricSize?: number;
  type: 'secret' | 'public' | 'private';
}

type crypto$ScryptOptions = {
  N?: number,
  r?: number,
  p?: number,
  maxmem?: number,
...
declare module 'crypto' {
  ...
  declare var Sign: Class<crypto$Sign>;
  declare var Verify: Class<crypto$Verify>;
  declare var ECDH: Class<crypto$ECDH>;

  declare var Certificate: {
    exportChallenge(spkac: string | Buffer | $TypedArray | DataView): Buffer;
    exportPublicKey(spkac: string | Buffer | $TypedArray | DataView, encoding?: string): Buffer;
    verifySpkac(spkac: Buffer | $TypedArray | DataView): boolean;
  };

  declare var constants: typeof crypto$constants;
  ...
  declare function createCipheriv(
    algorithm: string,
    key: string | Buffer | $TypedArray | DataView | crypto$KeyObject,
  ...
  declare function createPrivateKey(
    key: crypto$PrivateKeyInput | string | Buffer
  ): crypto$KeyObject;
  declare function createPublicKey(
    key: crypto$PublicKeyInput | string | Buffer | crypto$KeyObject
  ): crypto$KeyObject;
  declare function createSecretKey(key: Buffer): crypto$KeyObject;
  ...
  declare function getFips(): boolean;
  ...
  declare function privateDecrypt(
    private_key: crypto$RsaPrivateKey | string | Buffer | crypto$KeyObject,
  ...
  declare function publicDecrypt(
    key: crypto$RsaPublicKey | string | Buffer | crypto$KeyObject,
    buffer: Buffer | $TypedArray | DataView
  ): Buffer;
  ...
  declare function randomFillSync<T: Buffer | $TypedArray | DataView>(
    buffer: T
  ): void;
  declare function randomFillSync<T: Buffer | $TypedArray | DataView>(
    buffer: T,
  ...
  declare function randomFill<T: Buffer | $TypedArray | DataView>(
    buffer: T,
    callback: (err: ?Error, buffer: T) => void
  ): void;
  declare function randomFill<T: Buffer | $TypedArray | DataView>(
    buffer: T,
    offset: number,
  ...
  declare function generateKeyPairSync(
    type: 'rsa',
    options: crypto$RSAKeyPairOptions<'pem', 'der'>
  ): crypto$KeyPairSyncResult<string, Buffer>;
  declare function generateKeyPairSync(
    type: 'rsa',
    options: crypto$RSAKeyPairOptions<'der', 'pem'>
  ): crypto$KeyPairSyncResult<Buffer, string>;
  declare function generateKeyPairSync(
    type: 'rsa',
    options: crypto$RSAKeyPairOptions<'der', 'der'>
  ): crypto$KeyPairSyncResult<Buffer, Buffer>;
  declare function generateKeyPairSync(
    type: 'rsa',
    options: crypto$RSAKeyPairKeyObjectOptions
  ): crypto$KeyPairKeyObjectResult;

  declare function generateKeyPairSync(
    type: 'dsa',
    options: crypto$DSAKeyPairOptions<'pem', 'pem'>
  ): crypto$KeyPairSyncResult<string, string>;
  declare function generateKeyPairSync(
    type: 'dsa',
    options: crypto$DSAKeyPairOptions<'pem', 'der'>
  ): crypto$KeyPairSyncResult<string, Buffer>;
  declare function generateKeyPairSync(
    type: 'dsa',
    options: crypto$DSAKeyPairOptions<'der', 'pem'>
  ): crypto$KeyPairSyncResult<Buffer, string>;
  declare function generateKeyPairSync(
    type: 'dsa',
    options: crypto$DSAKeyPairOptions<'der', 'der'>
  ): crypto$KeyPairSyncResult<Buffer, Buffer>;
  declare function generateKeyPairSync(
    type: 'dsa',
    options: crypto$DSAKeyPairKeyObjectOptions
  ): crypto$KeyPairKeyObjectResult;

  declare function generateKeyPairSync(
    type: 'ec',
    options: crypto$ECKeyPairOptions<'pem', 'pem'>
  ): crypto$KeyPairSyncResult<string, string>;
  declare function generateKeyPairSync(
    type: 'ec',
    options: crypto$ECKeyPairOptions<'pem', 'der'>
  ): crypto$KeyPairSyncResult<string, Buffer>;
  declare function generateKeyPairSync(
    type: 'ec',
    options: crypto$ECKeyPairOptions<'der', 'pem'>
  ): crypto$KeyPairSyncResult<Buffer, string>;
  declare function generateKeyPairSync(
    type: 'ec',
    options: crypto$ECKeyPairOptions<'der', 'der'>
  ): crypto$KeyPairSyncResult<Buffer, Buffer>;
  declare function generateKeyPairSync(
    type: 'ec',
    options: crypto$ECKeyPairKeyObjectOptions
  ): crypto$KeyPairKeyObjectResult;
  ...
  declare function setEngine(engine: string, flags?: number): void;
  declare function setFips(fips: boolean): void;
}
