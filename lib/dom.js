...
declare class Document extends Node {
    ...
    // tree traversal
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow: 2, filter?: NodeFilter): NodeIterator<RootNodeT, Attr>;
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow: 4, filter?: NodeFilter): NodeIterator<RootNodeT, Text>;
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow: 128, filter?: NodeFilter): NodeIterator<RootNodeT, Comment>;
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow: 256, filter?: NodeFilter): NodeIterator<RootNodeT, Document>;
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow: 512, filter?: NodeFilter): NodeIterator<RootNodeT, DocumentType>;
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow: 1024, filter?: NodeFilter): NodeIterator<RootNodeT, DocumentFragment>;
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow?: number, filter?: NodeFilter): NodeIterator<RootNodeT, Node>;
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow: 2, filter?: NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, Attr>;
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow: 4, filter?: NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, Text>;
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow: 128, filter?: NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, Comment>;
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow: 256, filter?: NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, Document>;
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow: 512, filter?: NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, DocumentType>;
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow: 1024, filter?: NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, DocumentFragment>;
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow?: number, filter?: NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, Node>;
}
...
//   < "object"
//   > new NodeFilter()
//   < TypeError: NodeFilterConstructor is not a constructor
// behaves like a constructor:
//   > var i = document.createNodeIterator(document.body)
//   > i.filter instanceof NodeFilter
//   < true
...
//   < "object"
//   > new NodeIterator()
//   < TypeError: NodeIteratorConstructor is not a constructor
// behaves like a constructor:
//   > var i = document.createNodeIterator(document.body)
//   > i instanceof NodeIterator
//   < true
...
//   < "object"
//   > new TreeWalker()
//   < TypeError: TreeWalkerConstructor is not a constructor
// behaves like a constructor:
//   > var w = document.createTreeWalker(document.body)
//   > w instanceof TreeWalker
//   < true
