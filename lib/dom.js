...
declare interface SubtleCrypto {
  ...
  deriveKey(algorithm: SubtleCrypto$DeriveKeyAlgorithm, masterKey: CryptoKey, derivedKeyAlgorithm: DOMString | SubtleCrypto$DerivedKeyAlgorithm, extractable: Boolean, keyUsages: CryptoKey$Usages[]): Promise<CryptoKey | CryptoKeyPair>;
  ...
  generateKey(algo: SubtleCrypto$GenerateKeyAlgo, extractable: Boolean, keyUsages: CryptoKey$Usages[]): Promise<CryptoKey | CryptoKeyPair>;
  importKey(format: SubtleCrypto$KeyFormat, keyData: ArrayBuffer | JSONWebKey, algo: SubtleCrypto$GenerateKeyAlgo, extractable: Boolean, usages: CryptoKey$Usages[]): Promise<CryptoKey>;
