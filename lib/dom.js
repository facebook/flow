...
declare class CanvasRenderingContext2D {
    ...
    putImageData(imagedata: ImageData, dx: double, dy: double): void;
    putImageData(imagedata: ImageData, dx: double, dy: double, dirtyX: double, dirtyY: double, dirtyWidth: double, dirtyHeight: double): void;
