...
declare class Document extends Node {
    ...
    // tree traversal
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow: 2, filter?: NodeFilterInterface): NodeIterator<RootNodeT, Attr>;
    ...
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow: 256, filter?: NodeFilterInterface): NodeIterator<RootNodeT, Document>;
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow: 512, filter?: NodeFilterInterface): NodeIterator<RootNodeT, DocumentType>;
    createNodeIterator<RootNodeT: Node>(root: RootNodeT, whatToShow: 1024, filter?: NodeFilterInterface): NodeIterator<RootNodeT, DocumentFragment>;
    ...
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow: 2, filter?: NodeFilterInterface, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, Attr>;
    ...
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow: 256, filter?: NodeFilterInterface, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, Document>;
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow: 512, filter?: NodeFilterInterface, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, DocumentType>;
    createTreeWalker<RootNodeT: Node>(root: RootNodeT, whatToShow: 1024, filter?: NodeFilterInterface, entityReferenceExpansion: ?boolean): TreeWalker<RootNodeT, DocumentFragment>;
...
declare class NodeFilter {
  ...
  // NodeFilter.FILTER_ACCEPT or NodeFilter.FILTER_REJECT or NodeFilter.FILTER_SKIP
  acceptNode(node: Node): number;
}

// returns an enum. one of:
// NodeFilter.FILTER_ACCEPT or NodeFilter.FILTER_REJECT or NodeFilter.FILTER_SKIP
type NodeFilterInterface = (node: Node) => number | { acceptNode: (node: Node) => number };
