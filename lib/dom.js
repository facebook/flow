...
type ClipboardEvent$Init = Event$Init & { clipboardData: DataTransfer | null, ... };
...
// And also: https://dom.spec.whatwg.org/#dictdef-elementcreationoptions
...
declare class Document extends Node {
  ...
  createElement(tagName: string, options?: ElementCreationOptions): HTMLElement | HTMLUnknownElement;
