...
declare class Document extends Node {
    ...
    createNodeIterator(root: any, whatToShow?: 1, filter?: NodeFilterInterface): NodeIterator<Element>;
    createNodeIterator(root: any, whatToShow?: 2, filter?: NodeFilterInterface): NodeIterator<Attr>;
    createNodeIterator(root: any, whatToShow?: 4, filter?: NodeFilterInterface): NodeIterator<Text>;
    createNodeIterator(root: any, whatToShow?: 128, filter?: NodeFilterInterface): NodeIterator<Comment>;
    createNodeIterator(root: any, whatToShow?: 256, filter?: NodeFilterInterface): NodeIterator<Document>;
    createNodeIterator(root: any, whatToShow?: 512, filter?: NodeFilterInterface): NodeIterator<DocumentType>;
    createNodeIterator(root: any, whatToShow?: 1024, filter?: NodeFilterInterface): NodeIterator<DocumentFragment>;
    createNodeIterator(root: any, whatToShow?: number, filter?: NodeFilterInterface): NodeIterator<Node>;
    createTreeWalker(root: any, whatToShow?: 1, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Element>;
    createTreeWalker(root: any, whatToShow?: 2, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Attr>;
    createTreeWalker(root: any, whatToShow?: 4, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Text>;
    createTreeWalker(root: any, whatToShow?: 128, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Comment>;
    createTreeWalker(root: any, whatToShow?: 256, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Document>;
    createTreeWalker(root: any, whatToShow?: 512, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<DocumentType>;
    createTreeWalker(root: any, whatToShow?: 1024, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<DocumentFragment>;
    createTreeWalker(root: any, whatToShow?: number, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Node>;
}
