...
declare class HTMLCollection {
    ...
    length: number;
    item(nameOrIndex?: any, optionalIndex?: any): HTMLElement;
...
declare class Document extends Node {
    ...
    createNodeIterator(root: Node, whatToShow?: 1, filter?: NodeFilterInterface): NodeIterator<Element>;
    createNodeIterator(root: Node, whatToShow?: 2, filter?: NodeFilterInterface): NodeIterator<Attr>;
    createNodeIterator(root: Node, whatToShow?: 4, filter?: NodeFilterInterface): NodeIterator<Text>;
    createNodeIterator(root: Node, whatToShow?: 128, filter?: NodeFilterInterface): NodeIterator<Comment>;
    createNodeIterator(root: Node, whatToShow?: 256, filter?: NodeFilterInterface): NodeIterator<Document>;
    createNodeIterator(root: Node, whatToShow?: 512, filter?: NodeFilterInterface): NodeIterator<DocumentType>;
    createNodeIterator(root: Node, whatToShow?: 1024, filter?: NodeFilterInterface): NodeIterator<DocumentFragment>;
    createNodeIterator(root: Node, whatToShow?: number, filter?: NodeFilterInterface): NodeIterator<Node>;
    createTreeWalker(root: Node, whatToShow?: 1, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Element>;
    createTreeWalker(root: Node, whatToShow?: 2, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Attr>;
    createTreeWalker(root: Node, whatToShow?: 4, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Text>;
    createTreeWalker(root: Node, whatToShow?: 128, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Comment>;
    createTreeWalker(root: Node, whatToShow?: 256, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Document>;
    createTreeWalker(root: Node, whatToShow?: 512, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<DocumentType>;
    createTreeWalker(root: Node, whatToShow?: 1024, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<DocumentFragment>;
    createTreeWalker(root: Node, whatToShow?: number, filter?: NodeFilterInterface, entityReferenceExpansion?: boolean): TreeWalker<Node>;
}
...
//       as far as `instanceof` is conerned, but it is not callable.
...
//       as far as `instanceof` is conerned, but it is not callable.
declare class NodeIterator<WhatToShowT> {
  root: any;
  whatToShow: number;
  filter: NodeFilter;
...
//       as far as `instanceof` is conerned, but it is not callable.
declare class TreeWalker<WhatToShowT> {
  root: any;
  whatToShow: number;
  filter: NodeFilter;
  expandEntityReferences: boolean;
