...
type DragEventListener = {handleEvent: DragEventHandler} | EventHandler
...
type DragEventTypes = 'drag' | 'dragend' | 'dragenter' | 'dragexit' | 'dragleave' | 'dragover' | 'dragstart' | 'dragstop';
