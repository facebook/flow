...
declare class Document extends Node {
    ...
    // tree traversal
    createNodeIterator(root: Node, whatToShow: 2, filter: ?NodeFilter): NodeIterator<Attr>;
    createNodeIterator(root: Node, whatToShow: 4, filter: ?NodeFilter): NodeIterator<Text>;
    createNodeIterator(root: Node, whatToShow: 128, filter: ?NodeFilter): NodeIterator<Comment>;
    createNodeIterator(root: Node, whatToShow: 256, filter: ?NodeFilter): NodeIterator<Document>;
    createNodeIterator(root: Node, whatToShow: 512, filter: ?NodeFilter): NodeIterator<DocumentType>;
    createNodeIterator(root: Node, whatToShow: 1024, filter: ?NodeFilter): NodeIterator<DocumentFragment>;
    createNodeIterator(root: Node, whatToShow: ?number, filter: ?NodeFilter): NodeIterator<Node>;
    createTreeWalker(root: Node, whatToShow: 2, filter: ?NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<Attr>;
    createTreeWalker(root: Node, whatToShow: 4, filter: ?NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<Text>;
    createTreeWalker(root: Node, whatToShow: 128, filter: ?NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<Comment>;
    createTreeWalker(root: Node, whatToShow: 256, filter: ?NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<Document>;
    createTreeWalker(root: Node, whatToShow: 512, filter: ?NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<DocumentType>;
    createTreeWalker(root: Node, whatToShow: 1024, filter: ?NodeFilter, entityReferenceExpansion: ?boolean): TreeWalker<DocumentFragment>;
