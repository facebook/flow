...
declare class Notification extends EventTarget {
  constructor(title: string, ?optiions: NotificationOptions) : void;                           
  static permission: NotificationPermission;
  static requestPermission(callback?: (perm: NotificationPermission) => mixed): Promise<NotificationPermission>;
