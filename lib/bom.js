...
declare class XDomainRequest {
    ...
    responseText: string;
    contentType: string;
    open(method: MethodType, url: string): void;
    abort(): void;
    send(data?: any): void;
...
declare class XMLHttpRequest extends EventTarget {
    ...
    msCaching: string;
    open(method: MethodType, url: string, async?: boolean, user?: string, password?: string): void;
    send(data?: any): void;
    abort(): void;
...
type MethodType = 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH';
