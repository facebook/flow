...
type ProgressEventListener = (ev: ProgressEvent) => any;
...
declare class XMLHttpRequest extends EventTarget {
    ...
    responseText: string;
    responseXML: any;
    ontimeout: ProgressEventListener;
    statusText: string;
    onreadystatechange: (ev: Event) => any;
    timeout: number;
    onload: ProgressEventListener;
    response: any;
    withCredentials: boolean;
    onprogress: ProgressEventListener;
    onabort: ProgressEventListener;
    responseType: string;
    onloadend: ProgressEventListener;
    upload: XMLHttpRequestEventTarget;
    onerror: ProgressEventListener;
    onloadstart: ProgressEventListener;
    msCaching: string;
    addEventListener(type: ProgressEventTypes, listener: ProgressEventListener, useCapture?: boolean): void;
    removeEventListener(type: ProgressEventTypes, listener: ProgressEventListener, useCapture?: boolean): void;
