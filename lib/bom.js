...
declare function TrustedTypePolicyFactory$isHTML(value: mixed): boolean %checks(value instanceof TrustedHTML);
declare function TrustedTypePolicyFactory$isScript(value: mixed): boolean %checks(value instanceof TrustedScript);
declare function TrustedTypePolicyFactory$isScriptURL(value: mixed): boolean %checks(value instanceof TrustedScriptURL);
...
declare class TrustedTypePolicyFactory {
  ...
  +isHTML: typeof TrustedTypePolicyFactory$isHTML;
  +isScript: typeof TrustedTypePolicyFactory$isScript;
  +isScriptURL: typeof TrustedTypePolicyFactory$isScriptURL;
