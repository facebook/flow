...
interface IteratorObject<out Yield,out Return=void,in Next=void> extends Iterator<Yield,Return,Next>, Iterable<Yield,Return,Next> {
     ...
     */
    map<U>(callbackfn: (value: Yield, index: number) => U): IteratorObject<U, void, unknown>;
    /**
     ...
     */
    filter(callbackfn: typeof Boolean): IteratorObject<NonNullable<Yield>, void, unknown>;
    /**
     * Returns a new iterator that yields only those elements of the iterator for which the provided predicate returns a truthy value.
     * @param callbackfn A function that accepts up to two arguments: the yielded value and its index. The filter method calls the predicate function once per iteration.
     */
    ...
    >(callbackfn: (value: Yield, index: number) => implies value is Refined): IteratorObject<Refined, void, unknown>;
    /**
     * Returns a new iterator that yields only those elements of the iterator for which the provided predicate returns a truthy value.
     * @param callbackfn A function that accepts up to two arguments: the yielded value and its index. The filter method calls the predicate function once per iteration.
     */
    filter(callbackfn: (value: Yield, index: number) => unknown): IteratorObject<Yield, void, unknown>;
    /**
     * Returns a new iterator that yields up to the given number of elements in this iterator and then terminates.
     * @param limit The maximum number of values to yield.
     */
    take(limit: number): IteratorObject<Yield, void, unknown>;
    /**
     ...
     */
    drop(count: number): IteratorObject<Yield, void, unknown>;
    /**
     ...
     */
    flatMap<U>(callbackfn: (value: Yield, index: number) => Iterator<U, unknown, void> | Iterable<U, unknown, void>): IteratorObject<U, void, unknown>;
    /**
...
interface IteratorConstructor {
     ...
     */
    from<Yield, Return, Next>(
      source: Iterator<Yield,Return,Next> | Iterable<Yield,Return,Next>
    ): IteratorObject<Yield,Return,Next>;
}
