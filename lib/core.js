...
declare class $ReadOnlyArray<+T> {
     ...
     *
     * NOTE: type-guards are not officially released yet. They are only enabled in libdefs for testing purposes.
     * As such, this overload will not be used by default in source files. Support for type guards can be enabled
     * everywhere with the use of the `experimental.type_guards=true` flag.
     */
 ...
 */
declare class WeakRef<T: interface {} | $ReadOnlyArray<mixed>> {
...
type Parameters<T: (...args: $ReadOnlyArray<empty>) => mixed> =
  T extends (...args: infer Args) => mixed ? Args : empty;
