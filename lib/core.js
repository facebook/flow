...
declare class RegExp {
    ...
    toString(): string;
    readonly [Symbol.match]: (str: string) => Iterator<RegExp$matchResult>;
    readonly [Symbol.matchAll]: (str: string) => Iterator<RegExp$matchResult>;
}
...
declare class ArrayBuffer {
    ...
    static readonly [Symbol.species]: Class<this>;
}
