...
declare class $ReadOnlyWeakSet<T: interface {} | $ReadOnlyArray<mixed>> {
    has(value: T): boolean;
}

declare class WeakSet<T: interface {} | $ReadOnlyArray<mixed>> extends $ReadOnlyWeakSet<T> {
    constructor(iterable?: ?Iterable<T>): void;
...
type $Facebookism$Idx = <IdxObject, IdxResult>(
  object: IdxObject, f: (_: $Facebookism$IdxWrapper<IdxObject>) => IdxResult,
) => ?$Facebookism$IdxUnwrapper<IdxResult>;

declare class BigInt {
  static (value: boolean | string | number | interface {} | $ReadOnlyArray<mixed>): bigint;
  /**
