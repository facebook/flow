...
declare class Boolean { statics: { $call(value:any):boolean; }; }
//
...
declare class String {
    ...
    statics: { $call(value:any):string;
        fromCharCode(...codes: Array<number>): string;
    }
}

declare class RegExp { statics: { $call(pattern: string, flags?: string): RegExp; };
...
declare class Error { statics: { $call(message?:string):Error; };
    name: string;
    message: string;
    stack: string;
}
