...
declare class Array<T> {
    ...
    //since items are copied to this array, we can use bounded poly
    concat<S:T>(...items: Array<Array<S> | S>): Array<T>;
...
declare class String {
    ...
    contains(substr: string): boolean; // TODO: Remove in favor of includes()?
    ...
    startsWith(searchString: string, position?: number): boolean;
    static fromCodePoint(...points: Array<number>): string;
}
...
declare class Promise<R> {
    ...
    done<U>(onFulfill?: (value: R) => void, onReject?: (error: any) => void): Promise<U>;
