...
declare class Array<T> extends $ReadOnlyArray<T> {
     ...
     * predicate. If it is not provided, undefined is used instead.
     */
    find<This, S extends T>(callbackfn: (this : This, value: T, index: number, array: Array<T>) => implies value is S, thisArg: This): S | void;
    /**
     * Returns the value of the first element in the array where predicate is true, and undefined
     * otherwise.
     * @param callbackfn find calls predicate once for each element of the array, in ascending
...
// to be deprecated
declare class $ReadOnlyWeakMap<K extends WeaklyReferenceable, +V> {
    get(key: K): V | void;
    has(key: K): boolean;
}

type ReadonlyWeakMap<K extends WeaklyReferenceable, +V> = $ReadOnlyWeakMap<K, V>;
...
declare class $TypedArrayInternal<T extends number | bigint> {
    /**
 ...
 */
type EnumValue<
  +TRepresentationType extends EnumRepresentationTypes = EnumRepresentationTypes
 ...
 */
type Enum<+TEnumValue extends EnumValue<> = EnumValue<>> = $Enum<TEnumValue>;
...
type ClassDecorator = <TFunction extends (...ReadonlyArray<unknown>) => unknown>(target: TFunction) => TFunction | void;
