...
// Well known Symbols.
declare class SymbolHasInstance mixin Symbol {}
declare class SymboIsConcatSpreadable mixin Symbol {}
declare class SymbolIterator mixin Symbol {}
declare class SymbolMatch mixin Symbol {}
declare class SymbolReplace mixin Symbol {}
declare class SymbolSearch mixin Symbol {}
declare class SymbolSpecies mixin Symbol {}
declare class SymbolSplit mixin Symbol {}
declare class SymbolToPrimitive mixin Symbol {}
declare class SymbolToStringTag mixin Symbol {}
declare class SymbolUnscopables mixin Symbol {}
...
declare class Date {
    ...
    [key: SymbolToPrimitive](hint: 'string' | 'default'): string;
    [key: SymbolToPrimitive](hint: 'number'): number;
}
...
declare class Map<K, V> {
    ...
    size: number;
    values(): Iterator<V>;
    [key: SymbolToStringTag](): 'Map';
    [key: SymbolSpecies]: Function; // This would the Map constructor, can't think of a way to correctly type this
}
