...
declare class String {
     ...
     */
    static raw: (callSite: interface {readonly raw: ReadonlyArray<string>}, ...substitutions: ReadonlyArray<unknown>) => string;
}
...
declare class $Generator<out Yield,out Return,in Next> extends Iterator<Yield,Return,Next> {
 ...
 */
type Generator<out Yield,out Return,in Next> = $Generator<Yield,Return,Next>;
...
type $SettledPromiseResult<out T> = {
...
type PromiseSettledResult<out T> = $SettledPromiseResult<T>;
...
interface GeneratorFunction {
  ...
  readonly length: number;
  readonly name: string;
  readonly prototype: Generator<any, any, any>;
}
...
type AsyncIterableIterator<out T> = $AsyncIterator<T, void, void>;
...
type AsyncIteratorObject<out T, TReturn = void, TNext = void> = $AsyncIterator<T, TReturn, TNext>;
...
type TupleIterator<out T> = Iterator<T>;
type RegExpStringIterator<out T> = Iterator<T>;
