...
declare class Object {
    ...
    static getOwnPropertySymbols(o: $NotNullOrVoid): Array<symbol & Symbol>;
...
// Well known Symbols.
declare opaque type $SymbolHasInstance: symbol & Symbol;
declare opaque type $SymboIsConcatSpreadable: symbol & Symbol;
declare opaque type $SymbolIterator: symbol & Symbol;
declare opaque type $SymbolMatch: symbol & Symbol;
declare opaque type $SymbolMatchAll: symbol & Symbol;
declare opaque type $SymbolReplace: symbol & Symbol;
declare opaque type $SymbolSearch: symbol & Symbol;
declare opaque type $SymbolSpecies: symbol & Symbol;
declare opaque type $SymbolSplit: symbol & Symbol;
declare opaque type $SymbolToPrimitive: symbol & Symbol;
declare opaque type $SymbolToStringTag: symbol & Symbol;
declare opaque type $SymbolUnscopables: symbol & Symbol;

declare class Symbol {
  static (value?:any): symbol & Symbol;
  static for(key: string): symbol & Symbol;
  ...
  static keyFor(sym: symbol | Symbol): ?string;
  static length: 0;
...
declare class Promise<+R> {
    ...
    static allSettled<T: Iterable<mixed>>(promises: T): Promise<$TupleMap<T, typeof $settlement>>;
...
declare type SettlementResult<T> = {| status: 'fulfilled', value: T |} | {| status: 'rejected', reason: mixed |};
