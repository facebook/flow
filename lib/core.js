...
declare class Map<K, V> extends $ReadOnlyMap<K, V> {
    ...
    values(): Iterator<V>;
    // Multiple Indexers not yet supported
    [key: $SymbolToStringTag]: Function;
    static +[key: $SymbolToStringTag | $SymbolSpecies]: Function;
}
...
declare class Set<T> extends $ReadOnlySet<T> {
    ...
    values(): Iterator<T>;
    [key: $SymbolToStringTag]: Function;
    static +[key: $SymbolSpecies]: Function; // This would the Set constructor, can't think of a way to correctly type this
}
