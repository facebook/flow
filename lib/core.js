...
type RegExp$flags =
  ...
  'igm' | 'igy' | 'img' | 'imy' | 'iym' | 'iyg' | 'gim' | 'gym' | 'gmi' | 'gmy' | 'gyi' | 'giy' | 'mig' |
  'mgi' | 'myg' | 'mgy' | 'miy' | 'myi' |
  'igmy' | 'igym' | 'imgy' | 'imyg' | 'iygm' | 'iymg' | 'giym' | 'gimy' | 'gmyi' | 'gmiy' | 'gymi' |
  'gyim' | 'migy' | 'miyg' | 'mgiy' | 'mgyi' | 'myig' | 'mygi' | 'yimg' | 'yigm' | 'ygmi' | 'ygim' |
  'ymgi' | 'ymig'
