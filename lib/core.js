...
declare class Object {
    ...
    static getOwnPropertyNames<T: $Exact<any>>(o: T): Array<$Keys<T>>;
    static getOwnPropertyNames<T: {[$Subtype<string>]: mixed}>(o: T): Array<$Keys<T>>;
    ...
    static keys<T: $Exact<any>>(o: T): Array<$Keys<T>>;
    static keys<T: {[$Subtype<string>]: mixed}>(o: T): Array<$Keys<T>>;
