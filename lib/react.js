 ...
 * of ReactComponent. We make the type of a React class parametric over Config,
 * which is derived from some of the type parameters (DefaultProps, Props) of
 * ReactComponent, abstracting away others (State); whereas a ReactComponent
 * type is useful for checking the definition of a React class, a ReactClass
 * type (and the corresponding ReactElement type, see below) is useful for
 ...
 */
type ReactClass<DefaultPropsAndProps_DEPRECATED, Config, State_DEPRECATED> = _ReactClass<*, *, Config, *>;
type _ReactClass<DefaultProps, Props, Config: $Diff<Props, DefaultProps>, C: ReactComponent<DefaultProps, Props, any>> = Class<C>;
 ...
 * parameterization of ReactElement mimics that of ReactClass (see above).
 */
declare class ReactElement<DefaultPropsAndProps_DEPRECATED, Config, State_DEPRECATED> {
  type: ReactClass<any, Config, any>;
...
declare module react {
  ...
  declare function cloneElement<Config> (
    element: ReactElement<any, Config, any>,
    attributes: $Shape<Config>,
    children?: any
  ): ReactElement<any, Config, any>;
   ...
   * props to obtain the props of a ReactElement / ReactComponent instance.
   */
  // TODO: React DOM elements
  declare function createElement<Config>(
    name: ReactClass<any, Config, any>,
    config: Config,
    children?: any
  ): ReactElement<any, Config, any>;
  ...
  declare function createFactory<Config>(
    name: ReactClass<any, Config, any>
  ): (config: Config, children?: any) => ReactElement<any, Config, any>;
  ...
  declare function constructAndRenderComponent<Config>(
    ...
    config: Config,
    container: any
  ): ReactComponent<$DefaultPropsOf<Config>, $PropsOf<Config>, any>;
