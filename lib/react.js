...
declare type React$AbstractComponentStatics<DefaultProps> = {
 ...
 */
declare type React$ComponentType<-Config> = React$AbstractComponent<Config, any, any>;
...
declare type React$ElementType =
  | string
  | React$AbstractComponent<any, any, any>;
