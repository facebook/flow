...
type React$CloneElement =
  ...
  & (<Props, C: React$AbstractComponent<empty>, E: React$Element<C, Props>>(
    element: E,
    props?: ?Partial<$ReadOnly<{|...$Exact<NoInfer<Props>>, key: React$Key, ref: ?React$Ref<NoInfer<C>>|}>>,
  ) => E)
  & (<Props, C: React$AbstractComponent<empty>, E: React$Element<C, Props>>(
    element: E,
    props: ?Partial<$ReadOnly<{|...$Exact<NoInfer<Props>>, key: React$Key, ref: ?React$Ref<NoInfer<C>>|}>>,
...
declare module react {
  ...
  declare namespace React {
    ...
    declare function lazy<Config, Instance = mixed, Renders: React$Node = React$Node>(
      component: () => Promise<
        $ReadOnly<{
          default: React$AbstractComponent<Config, Instance, Renders>,
          ...
        }>
      >,
    ): React$AbstractComponent<Config, Instance, Renders>;
    ...
    type AbstractComponent<
      ...
      +Renders: React$Node = React$Node,
    > = React$AbstractComponent<Config, Instance, Renders>;
    type PropsOf<E: string | React$MixedElement> = globalThis.React.PropsOf<E>;
    type PropOf<E: string | React$MixedElement, K: string> = globalThis.React.PropOf<E, K>;
    type RefOf<E: string | React$MixedElement> = globalThis.React.RefOf<E>;
    type MixedElement = React$MixedElement;
    type ElementType = React$ElementType;
