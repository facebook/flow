...
declare class ReactGraphQLComparatorsMixin {
    isStateEqualTo(nextState: any): boolean;
    isContextEqualTo(nextContext: any): boolean;
    isPropsEqualTo(nextProps: any): boolean;
}

declare class ReactGraphQLMixin<Q,X> {
    props: $Subtype<$Record<Q>>;
    mixins: $Tuple<ReactGraphQLComparatorsMixin>;
    statics: {
        queries: Q;
        queryParams: X;
        getQuery(propName: $Enum<Q>): any;
        getQueriesForRoute(route: any): any;
    };
    setQueryParams(queryParams: X): void;
    queryParams: X;
}
