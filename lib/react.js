...
declare class ReactClass<D,P,S> {
    propTypes: $Record<P>;
    contextTypes: any;
...
//    declare function createElement<D,P,S,A>(name: string, props?: any, children?: any): any;
    declare function createElement<D,P,S,A:$Diff<P,D>>(name: ReactClass<D,P,S>, props: A, children?: any): ReactElement<D,P,S>;

    declare function cloneElement<A,P,S>(element: ReactElement<A,P,S>, props: A & $Shape<P>, children?: any): ReactElement<A,P,S>;

//    declare function createFactory<D,P,S,A>(name: string): (props?: any, children?: any) => any;
    declare function createFactory<D,P,S,A:$Diff<P,D>>(name: ReactClass<D,P,S>): (props: A, children?: any) => ReactElement<D,P,S>;

//    declare function constructAndRenderComponent<D,P,S,A>(name: string, props: any, container: any): any;
    declare function constructAndRenderComponent<D,P,S,A:$Diff<P,D>>(name: ReactClass<D,P,S>, props: A, container: any): ReactComponent<D,P,S>;

//    declare function constructAndRenderComponentByID<D,P,S,A>(name: string, props: any, id: string): any;
    declare function constructAndRenderComponentByID<D,P,S,A:$Diff<P,D>>(name: ReactClass<D,P,S>, props: A, id: string): ReactComponent<D,P,S>;

    declare function findDOMNode(object: ReactComponent<any,any,any> | HTMLElement): any;

    declare function render<D,P,S>(element: ReactElement<D,P,S>, container: any): ReactComponent<D,P,S>;
...
//    declare function createElement<A,P,D,S>(name: string, props?: any, children?: any): any;
    declare function createElement<A,P,D:$Diff<P,A>,S>(name: ReactClass<D,P,S>, props: A, children?: any): ReactElement<D,P,S>;

    declare function cloneElement<A,P,S>(element: ReactElement<A,P,S>, props: A & $Shape<P>, children?: any): ReactElement<A,P,S>;

//    declare function createFactory<A,P,D,S>(name: string): (props?: any, children?: any) => any;
    declare function createFactory<A,P,D:$Diff<P,A>,S>(name: ReactClass<D,P,S>): (props: A, children?: any) => ReactElement<D,P,S>;

//    declare function constructAndRenderComponent<A,P,D,S>(name: string, props: any, container: any): any;
    declare function constructAndRenderComponent<A,P,D:$Diff<P,A>,S>(name: ReactClass<D,P,S>, props: A, container: any): ReactComponent<D,P,S>;

//    declare function constructAndRenderComponentByID<A,P,D,S>(name: string, props: any, id: string): any;
    declare function constructAndRenderComponentByID<A,P,D:$Diff<P,A>,S>(name: ReactClass<D,P,S>, props: A, id: string): ReactComponent<D,P,S>;
