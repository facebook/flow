...
declare module react {
  ...
  declare export type PropsOf<E: string | React$Element<React$ElementType>> = E extends React$Element<infer C> ? React$ElementConfig<C> : (E extends string ? $JSXIntrinsics[E]['props'] : empty);
