 ...
 */
declare class React$Component<DefaultProps, Props, State = void> {
  // fields
...
declare module react {
  declare export var Children: any;
  ...
  declare export function cloneElement<Config> (
  ...
  declare export function createFactory<Config>(
  ...
  declare export var Element: typeof React$Element;

  declare export type Node = React$Node<any>;
