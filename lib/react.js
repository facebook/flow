...
declare type React$RenderableNode =
  | null
  | boolean
  | number
  | string
...
/**
 * If a node is not rendered, it can be undefined
 * e.g: an element from the children array may be undefined
 * React just won't render it.
 */

declare type React$Node =
  | void
  | React$RenderableNode
...
declare type React$StatelessFunctionalComponent<Props> = {
  (props: Props, context: any): React$RenderableNode,
  displayName?: ?string,
