 ...
 */
declare opaque type ExactReactElement_DEPRECATED<+ElementType: React$ElementType, +P = React$ElementConfig<ElementType>>: {...};
...
declare namespace React {
  ...
  type PropsOf<E: string | MixedElement | React$RendersExactly<React$ElementType>> = E extends ExactReactElement_DEPRECATED<infer C> ? ElementConfig<C> : E extends React$RendersExactly<infer C> ? ElementConfig<C> : (E extends string ? $JSXIntrinsics[E]['props'] : empty);
  type PropOf<E: string | MixedElement | React$RendersExactly<React$ElementType>, K: string> = PropsOf<E>[K]
  type RefOf<E: string | MixedElement | React$RendersExactly<React$ElementType>> = E extends ExactReactElement_DEPRECATED<infer C> ? ElementRef<C> : E extends React$RendersExactly<infer C> ? ElementRef<C> : (E extends string ? $JSXIntrinsics[E]['instance'] : empty);
  /**
   * @flowCustomError
   */
  ...
  type ElementRef<C: string | component(...empty)> =
    C extends empty ? any :
   ...
   */
  type JSXElementConstructor<P: {...} = {...}> = component(...P);
   ...
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  type FunctionComponent<P: {...} = {...}> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  type ComponentClass<P: {...} = {...}, S = any> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  type ForwardRefExoticComponent<P: {...} = {...}> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  type NamedExoticComponent<P: {...} = {...}> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  type ExoticComponent<P: {...} = {...}> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  type MemoExoticComponent<T: ComponentType<any>> = component(...React$ElementConfig<T>);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  type LazyExoticComponent<T: ComponentType<any>> = component(...React$ElementConfig<T>);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ElementConfig` instead.
   */
  type ComponentProps<T: React$ElementType> = React$ElementConfig<T>;
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ElementConfig` instead.
   */
  type ComponentPropsWithRef<T: React$ElementType> = React$ElementConfig<T>;
  /**
   * @deprecated TypeScript compatibility alias. Use `Omit<React.ElementConfig<T>, 'ref'>` instead.
   */
  type ComponentPropsWithoutRef<T: React$ElementType> = Omit<React$ElementConfig<T>, 'ref'>;
  /**
   * @deprecated TypeScript compatibility alias.
   */
   ...
   * @deprecated TypeScript compatibility alias.
   */
  type ActionDispatch<ActionArg: ReadonlyArray<any> = []> = (...args: ActionArg) => void;
}
...
type React$CloneElement =
  & (<C: keyof $JSXIntrinsics, E: ExactReactElement_DEPRECATED<C>>(
    element: E,
    props?: ?Partial<$JSXIntrinsics[C]['props']>,
    ...children: ReadonlyArray<React$Node>
  ) => E)
  & (<Props, C: component(...empty), E: ExactReactElement_DEPRECATED<C, Props>>(
    element: E,
...
declare module "react" {
  ...
  declare export type PropsOf<C: string | MixedElement | React$RendersExactly<React$ElementType>> = React.PropsOf<C>;
  declare export type PropOf<C: string | MixedElement | React$RendersExactly<React$ElementType>, K: string> = React.PropOf<C, K>;
  declare export type RefOf<C: string | MixedElement | React$RendersExactly<React$ElementType>> = React.RefOf<C>;
   ...
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  declare export type JSXElementConstructor<P: {...} = {...}> = component(...P);

  // TS compat: component types
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  declare export type FC<P: {...} = {...}> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  declare export type FunctionComponent<P: {...} = {...}> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  declare export type ComponentClass<P: {...} = {...}, S = any> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  declare export type ForwardRefExoticComponent<P: {...} = {...}> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  declare export type NamedExoticComponent<P: {...} = {...}> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  declare export type ExoticComponent<P: {...} = {...}> = component(...P);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  declare export type MemoExoticComponent<T: React.ComponentType<any>> = component(...React.ElementConfig<T>);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
   */
  declare export type LazyExoticComponent<T: React.ComponentType<any>> = component(...React.ElementConfig<T>);
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ElementConfig` instead.
   */
  declare export type ComponentProps<T: React.ElementType> = React.ElementConfig<T>;
  /**
   * @deprecated TypeScript compatibility alias. Use `React.ElementConfig` instead.
   */
  declare export type ComponentPropsWithRef<T: React.ElementType> = React.ElementConfig<T>;
  /**
   * @deprecated TypeScript compatibility alias. Use `Omit<React.ElementConfig<T>, 'ref'>` instead.
   */
  declare export type ComponentPropsWithoutRef<T: React.ElementType> = Omit<React.ElementConfig<T>, 'ref'>;
  /**
   * @deprecated TypeScript compatibility alias.
   */
   ...
   * @deprecated TypeScript compatibility alias.
   */
  declare export type ActionDispatch<ActionArg: ReadonlyArray<any> = []> = (...args: ActionArg) => void;
  ...
  declare namespace React {
     ...
     * @see https://react.dev/reference/react/memo
     */
    declare function memo<Config: {...}, Renders: React.Node = React.Node>(
     ...
     * @see https://react.dev/reference/react/lazy
     */
    declare function lazy<Config: {...}, Renders: React.Node = React.Node>(
      component: () => Promise<
        Readonly<{
     ...
     * `<Activity>` lets you hide and show parts of the UI.
     */
    declare const Activity: component<Renders: React.Node = void>(
      children?: React.Node,
      mode?: 'visible' | 'hidden',
    ) renders Renders;
     ...
     * [create a stable event function with the latest values that can be called in Effects](https://react.dev/learn/separating-events-from-effects)
     */
    declare hook useEffectEvent<F: (...empty) => unknown>(
      callback: F,
    ): F;
     ...
     * @see https://react.dev/reference/react/useCallback
     */
    declare hook useCallback<T: (...args: ReadonlyArray<empty>) => unknown>(
      callback: T,
      inputs: ?ReadonlyArray<unknown>,
    ): T;
    ...
    type ComponentType<-P: {...}> = component(...P);
    type PropsOf<C: string | MixedElement | React$RendersExactly<React$ElementType>> = globalThis.React.PropsOf<C>;
    type PropOf<C: string | MixedElement | React$RendersExactly<React$ElementType>, K: string> = globalThis.React.PropOf<C, K>;
    type RefOf<C: string | MixedElement | React$RendersExactly<React$ElementType>> = globalThis.React.RefOf<C>;
     ...
     * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
     */
    type MemoExoticComponent<T: ComponentType<any>> = component(...ElementConfig<T>);
    /**
     * @deprecated TypeScript compatibility alias. Use `React.ComponentType` instead.
     */
    type LazyExoticComponent<T: ComponentType<any>> = component(...ElementConfig<T>);
    /**
     * @deprecated TypeScript compatibility alias. Use `React.ElementConfig` instead.
     */
    type ComponentProps<T: ElementType> = ElementConfig<T>;
    /**
     * @deprecated TypeScript compatibility alias. Use `React.ElementConfig` instead.
     */
    type ComponentPropsWithRef<T: ElementType> = ElementConfig<T>;
    /**
     * @deprecated TypeScript compatibility alias. Use `Omit<React.ElementConfig<T>, 'ref'>` instead.
     */
    type ComponentPropsWithoutRef<T: ElementType> = Omit<ElementConfig<T>, 'ref'>;
    /**
     * @deprecated TypeScript compatibility alias.
     */
