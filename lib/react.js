...
type React$PropTypes$shape = (shapeTypes: { [key: string]: ReactPropsCheckType }) => ReactPropsChainableTypeChecker;
...
declare module react {
  ...
  declare type Empty = null | void | boolean;
  ...
  declare type Fragment = Iterable<Node>;
  declare type NodeList = Empty | Node;
}
