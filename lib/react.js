...
declare namespace React {
  ...
  type PropsOf<E: string | React$MixedElement> = E extends React$Element<infer C> ? React$ElementConfig<C> : (E extends string ? $JSXIntrinsics[E]['props'] : empty);
  type PropOf<E: string | React$MixedElement, K: string> = PropsOf<E>[K]
  type RefOf<E: string | React$MixedElement> = E extends React$Element<infer C> ? React$ElementRef<C> : (E extends string ? $JSXIntrinsics[E]['instance'] : empty);
   ...
   * literals, which desugar to React.createElement calls (see below).
   */
  type Element<+C, +P = React$ElementProps<C>> = React$Element<C, P>;
...
declare module react {
  declare export const DOM: typeof React.DOM;
  declare export const version: string;

  /** @deprecated */
  declare export const checkPropTypes: typeof React.checkPropTypes;

  /** @deprecated */
  declare export const createClass: React$CreateClass;
  /**
   ...
   * @deprecated
   */
  declare export const createFactory: typeof React.createFactory;
  /**
  ...
  declare export type AbstractComponent<
    ...
    +Renders: React$Node = React$Node,
  > = React$AbstractComponent<Config, Instance, Renders>;
  declare export type PropsOf<E: string | React$MixedElement> = React.PropsOf<E>;
  declare export type PropOf<E: string | React$MixedElement, K: string> = React.PropOf<E, K>;
  declare export type RefOf<E: string | React$MixedElement> = React.RefOf<E>;
  ...
  declare export const ConcurrentMode: typeof React.ConcurrentMode; // 16.7+
  /**
  ...
  declare namespace React {
     ...
     * @see https://react.dev/reference/react/memo
     */
    declare function memo<Config, Instance = mixed, Renders: React$Node = React$Node>(
     ...
     * @see https://react.dev/reference/react/lazy
     */
    declare function lazy<Config, Instance = mixed, Renders: React$Node = React$Node>(
      component: () => Promise<{ default: React$AbstractComponent<Config, Instance, Renders>, ... }>,
    ): React$AbstractComponent<Config, Instance, Renders>;

    declare const createClass: React$CreateClass;
     ...
     * @deprecated
     */
    declare function createFactory<ElementType: React$ElementType>(
      type: ElementType,
     ...
     * @see https://react.dev/reference/react/forwardRef
     */
    declare function forwardRef<Config, Instance, Renders: React$Node = React$Node>(
      render: (
        props: Config,
     ...
     * @see https://react.dev/reference/react/Fragment
     */
    declare component Fragment<Renders: React$Node = React$Node>(
      children?: Renders,
    ) renders Renders;
    ...
    declare const ConcurrentMode: ({ +children?: React$Node, ... }) => React$Node; // 16.7+
    /**
     * `<StrictMode>` lets you find common bugs in your components early
     * during development.
     *
     ...
     * @see https://react.dev/reference/react/Profiler
     */
    declare const Profiler: React$AbstractComponent<{|
      +children?: React$Node,
      +id: string,
     ...
     * @see https://react.dev/reference/react/useTransition
     */
    declare function useTransition(): [boolean, (() => void) => void];
     ...
     * @see https://react.dev/reference/react/useInsertionEffect
     */
    declare function useInsertionEffect(
      create: () => MaybeCleanUpFn,
      inputs?: ?$ReadOnlyArray<mixed>,
    ): void;
