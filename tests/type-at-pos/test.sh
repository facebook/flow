...
printf "function_expression.js:4:3 = "
assert_ok "$FLOW" type-at-pos function_expressions.js 4 3 --strip-root --pretty
printf "function_expression.js:8:3 = "
assert_ok "$FLOW" type-at-pos function_expressions.js 8 3 --strip-root --pretty
printf "function_expression.js:12:3 = "
assert_ok "$FLOW" type-at-pos function_expressions.js 12 3 --strip-root --pretty
printf "function_expression.js:16:3 = "
assert_ok "$FLOW" type-at-pos function_expressions.js 16 3 --strip-root --pretty
