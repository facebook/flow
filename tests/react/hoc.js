...
function myHOC(
  Component: component(ref?: React.RefSetter<unknown>, foo: number, bar: number),
): component(ref?: React.RefSetter<unknown>, foo: number) {
...
const Wrapped: component(ref?: React.RefSetter<unknown>, foo: number) = myHOC(Unwrapped);
