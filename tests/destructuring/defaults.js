...
function obj_prop_fun(
  {p: {q = 0} = {q: true}}: {p?: {q?: number | string, ...}, ...} = {p: {q: ''}},
) {
  // errors:
...
function obj_rest(
  {p: {q, ...o} = {q: 0, r: 0}}: {p?: {r?: string, ...}, ...} = {p: {q: 0, r: ''}},
) {
  // errors:
...
obj_prop_fun({} as {p?: {q?: number | string, ...}, ...}); // ok
obj_prop_var({} as {p?: {q?: number | string, ...}, ...}); // ok
