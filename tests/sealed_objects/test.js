...
var o3: { x: number; y?: string; ... } = { x: 0, y: 0 } as { x: number; ... };
var s3: string = o3.y || ""; // error

var o4: { x: number; y?: string; ... } = { x: 0 } as { x: number; [_:any]:any};
...
var o7: { x: number; y?: string; ... } = { x: 0, y: 0 } as { x: number; [_:any]:number}; // error
