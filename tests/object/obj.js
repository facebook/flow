...
Object.freeze<{...}>({});
Object.freeze<{readonly a: number, ...}>({a: 42, b: 42});
Object.freeze<{readonly a: number, ...}>({a: 42, b: 42}).b; // b is hidden
Object.freeze<{readonly c: number, ...}>({a: 42, b: 42}); // c does not exist
