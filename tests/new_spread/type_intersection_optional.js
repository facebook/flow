...
o1 as {readonly p?:T&U, ...}; // ok

declare const o2: {...{p?:T, ...}&{p:U, ...}, ...};
o2 as {readonly p?:T&U, ...}; // ok

declare const o3: {...{p:T, ...}&{p?:U, ...}, ...};
o3 as {readonly p?:T&U, ...}; // ok
...
o17 as {readonly p?:T, readonly q?:U, ...}; // ok

declare const o18: {...{p?:T, ...}&{q:U, ...}, ...};
o18 as {p?:T, readonly q?:U, ...}; // ok

declare const o19: {...{p:T, ...}&{q?:U, ...}, ...};
o19 as {readonly p?:T, q?:U, ...}; // ok

declare const o20: {...{p?:T, ...}&{q?:U, ...}, ...};
o20 as {p?:T,q?:U, ...}; // ok

declare const o21: {...{p:T}&{q:U, ...}, ...};
o21 as {p:T, readonly q?:U, ...}; // ok
