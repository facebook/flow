...
echo ""
assert_errors "$FLOW" --show-lazy-status # parse error is reported

echo "a as empty;" >> b.js
echo ""
echo "Parse error, but no typing error in b.js:"
echo ""
assert_errors "$FLOW" --show-lazy-status # this should be a parse error, but not a typing error (because of the parse error in a.js)
