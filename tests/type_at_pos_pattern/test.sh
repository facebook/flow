...
assert_ok "$FLOW" type-at-pos object.js 13 3 --strip-root
printf "object.js:14:3 = "
assert_ok "$FLOW" type-at-pos object.js 14 3 --strip-root
printf "object.js:15:4 = "
assert_ok "$FLOW" type-at-pos object.js 15 4 --strip-root

# A destructured binding is framed by the declaration it resolves to, so `b: b1`
# reports the bound name rather than the property name. The bare type is pinned
# in type_at_pos_json_pretty; 12:6 checks a name position the queries above miss.
