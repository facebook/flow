...
assert_ok "$FLOW" get-def imports.js 41 21 --strip-root --pretty
...
assert_ok "$FLOW" get-def imports.js 49 21 --strip-root --pretty
...
queries_in_file "get-def" "indexed_access.js"
