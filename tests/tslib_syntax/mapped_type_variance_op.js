...
type PlusReadOnly<T: {...}> = {+readonly [K in keyof T]: T[K]};
...
type MinusReadOnly<T: {...}> = {-readonly [K in keyof T]: T[K]};
...
type MutableFromWO<T: {...}> = {-readonly [K in keyof T]: T[K]};
