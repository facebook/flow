...
declare const user: Profile_user;
declare const userRef: Profile_userRef;
...
<Profile user={null as unknown} foo={null as unknown} />; // Error: unknown ~> ref and unknown ~> number
